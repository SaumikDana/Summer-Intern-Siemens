...
#mesh and function space for the original problem
nx=200
ny=200
...
u=TrialFunction(V) #trial space for the original problem
v=TestFunction(V) #test space for the original problem
...
t=0
counter=0
u_sol=u_i #initialize finite element solution for the original problem at t=0
